                ...
                <div class="cz-carousel">
                    <div class="cz-carousel-inner"
                        ...
                        <div>
                            <div class="row align-items-center">
                                <div class="col-md-6 order-md-2"><img class="d-block mx-auto"
                                        src="img/home/hero-slider/05.jpg" alt="VR Collection"></div>
                                <div
                                    ...
                                    <h5 class="font-weight-light pb-3 from-bottom delay-2">Choose between top brands
                        ...
                        <div>
                            <div class="row align-items-center">
                                <div class="col-md-6 order-md-2"><img class="d-block mx-auto"
                                        src="img/home/hero-slider/04.jpg" alt="VR Collection"></div>
                                <div
                                    class="col-lg-5 col-md-6 offset-lg-1 order-md-1 pt-4 pb-md-4 text-center text-md-left">
                                    <h2 class="font-weight-light pb-1 from-left">Explore the best</h2>
                                    <h1 class="display-4 from-left delay-1">VR Collection</h1>
                                    <h5 class="font-weight-light pb-3 from-left delay-2">on the market</h5><a
                        ...
                        <div>
                            <div class="row align-items-center">
                                <div class="col-md-6 order-md-2"><img class="d-block mx-auto"
                                        src="img/home/hero-slider/06.jpg" alt="VR Collection"></div>
                                <div
                                    class="col-lg-5 col-md-6 offset-lg-1 order-md-1 pt-4 pb-md-4 text-center text-md-left">
            ...
            <div class="col-xl-3 order-xl-1 pt-4 mt-3 mt-xl-0 pt-xl-0">
                <div class="table-responsive" data-simplebar>
                    <div class="d-flex d-xl-block"><a
                            class="media w-100 align-items-center bg-faded-info rounded-lg pt-2 pl-2 mb-4 mr-4 mr-xl-0"
                            href="#" style="min-width: 16rem;"><img src="img/home/banners/banner-sm01.png" width="125"
                                alt="Banner">
                            <div class="media-body py-4 px-2">
                                <h5 class="mb-2"><span class="font-weight-light">Next Gen</span><br>Video <span
                                        class="font-weight-light">with</span><br>360 Cam</h5>
                            ...
                            href="#" style="min-width: 16rem;"><img src="img/home/banners/banner-sm02.png" width="125"
                                alt="Banner">
                            <div class="media-body py-4 px-2">
                                ...
                                <div class="text-warning font-size-sm">Shop now<i
                                        class="czi-arrow-right font-size-xs ml-1"></i>
                                </div>
                            </div>
                        </a><a class="media w-100 align-items-center bg-faded-success rounded-lg pt-2 pl-2 mb-4"
                            href="#" style="min-width: 16rem;"><img src="img/home/banners/banner-sm03.png" width="125"
                                alt="Banner">
                            <div class="media-body py-4 px-2">
                                <h5 class="mb-2"><span class="font-weight-light">Catch Big</span><br>Deals <span
                                        class="font-weight-light">on</span><br>Earbuds</h5>
