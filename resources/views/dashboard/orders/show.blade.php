                ...
                <div class="card-body">
                    <div class="container-fluid d-flex justify-content-between">
                        <div class="col-lg-3 pl-0">
                            <a href="#" class="noble-ui-logo d-block mt-3">SAT<span>IF</span></a>
                            <p class="mt-1 mb-1"><b>NobleUI Themes</b></p>
                            <p>108,<br> Great Russell St,<br>London, WC1B 3NA.</p>
                            <h5 class="mt-5 mb-2 text-muted">Invoice to :</h5>
                            <p>{{ customers($order->customer_id, $customer) }},<br> 102, 102 Crown Street,<br> London, W3 3PR.</p>
                        </div>
                        <div class="col-lg-3 pr-0">
                            <h4 class="font-weight-medium text-uppercase text-right mt-4 mb-2">invoice</h4>
                            <h6 class="text-right mb-5 pb-4"># SIF-{{ $order->order_number }}</h6>
                            ...
                            <h6 class="mb-0 mt-3 text-right font-weight-normal mb-2"><span class="text-muted">Invoice
                                    Date
                                    :</span> 25rd Jan 2020</h6>
                            <h6 class="text-right font-weight-normal"><span class="text-muted">Due Date :</span> 12th
                                Jul
                                2020</h6>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid w-100">
                        ...
                        <a href="#" class="btn btn-outline-primary float-right mt-4"><i data-feather="printer"
