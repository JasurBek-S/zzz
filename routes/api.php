...
Route::get('/product', function () {
    ...
    <h4 class="modal-title product-title"><a href="shop-single-v2.html" data-toggle="tooltip"
            data-placement="right" title="Go to product page">Smartwatch Youth Edition<i
            ...
            <div class="cz-product-gallery">
                ...
                <div class="cz-thumblist order-sm-1"><a class="cz-thumblist-item active"
                        ...
                        class="cz-thumblist-item" href="#fourth"><img
                            src="img/shop/single/gallery/th08.jpg" alt="Product thumb"></a></div>
            </div>
        </div>
        <!-- Product details-->
